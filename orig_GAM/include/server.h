...
class Server {
  ...
  public:
    ...
    long ProcessRdmaRequest_total_time = 0;
    long ProcessRdmaRequest_recv_time = 0;
    long ProcessRdmaRequest_recv_with_imm_time = 0;
    long ProcessRdmaRequest_write_time = 0;
    long ProcessRdmaRequest_send_time = 0;
    long ProcessPendingWrite_time = 0;
