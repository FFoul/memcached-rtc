...
// Enable to use TLSF allocator instead of SLAB allocator
// Comment out to use the original SLAB implementation
// #define USE_TLSF
...
class SlabAllocator {
  ...
  pool_t tlsf_pool = NULL;
  pthread_mutex_t tlsf_lock;  // Lock for TLSF thread safety
#endif
