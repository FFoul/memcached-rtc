...
void Server::ProcessRdmaRequest(ibv_wc& wc) {
  ...
  switch (wc.opcode) {
    ...
    p_start_time = get_time(); 
      ...
      p_end_time = get_time();
      ProcessRdmaRequest_send_time += (p_end_time - p_start_time);
      break;
    case IBV_WC_RDMA_WRITE:
      ...
      //TODO: send out the waiting request
      p_end_time = get_time(); 
      ProcessRdmaRequest_write_time += (p_end_time - p_start_time);
      break;
    case IBV_WC_RECV: {
      p_start_time = get_time();
      ...
      //epicAssert(n == 1);
      p_end_time = get_time();
      ProcessRdmaRequest_recv_time += (p_end_time - p_start_time);
      break;
    }
    case IBV_WC_RECV_RDMA_WITH_IMM: {
      ...
      //epicAssert(n == 1);
      p_end_time = get_time();
      ProcessRdmaRequest_recv_with_imm_time += (p_end_time - p_start_time);
      break;
    }
    default:
